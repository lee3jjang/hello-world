...
#2. 데이터 불러오기 ('21.01)
보험료보험금_1월 = pd.read_excel('data/202101.xlsx', header=[0, 1])         # data 폴더에 있는 202101.xlsx 파일을 불러옴 ▶▶▶ 데이터를 "보험료보험금_1월" 변수로 저장
...
#6. 컬럼 합계 구하기
보험료_자동차_2021년 = 보험료보험금_2021년['보험료']['자동차'].sum()          # "보험료보험금_2021년" 변수의 보험료->자동차 컬럼 합계 계산 ▶▶▶ "보험료_자동차_2021년" 변수로 저장
