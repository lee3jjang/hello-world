...
#   - 이 셀프스터디의 목적은 파이썬(Python)을 이용해 이 파일들을 조작하는 법을 익히는 것입니다.
#
#  2. 스터디 방법
#   1) 아래(21번째 줄부터)는 파이썬으로 엑셀 파일을 조작하는 코드가 미리 작성되어 있습니다.
...
보험료보험금_2021년                                                         # "보험료보험금_2021년" 변수 출력
...
## Quiz
# 2023년 일반보험의 지급보험금 합계를 구하는 코드를 아래에 작성하세요   
