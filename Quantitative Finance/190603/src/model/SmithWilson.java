...
public class SmithWilson {
	...
	public RealVector maturities;
	public RealVector spotRates;
	public RealVector bondPrices;
	public RealVector forwardRates;
	
	public RealVector swaptionMaturity;
	public RealVector swapTenor;
	public RealMatrix blackVol;
	public RealMatrix blackRS;
	public int m1, m2;
	...
	private double getError(double alpha) {
		...
		return Math.abs(1e-4 - Math.abs(sw.forward(Math.max(llp+40, 60), 0)-ufr));
	}
